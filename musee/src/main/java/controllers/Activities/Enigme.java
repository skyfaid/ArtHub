...
public class Enigme {
    ...
    private void loadQuestions() {
        ...
        if (counter == 6) { //Question 7
            ...
            String imagePath = "D:\\artHub2\\musee\\src\\main\\resources\\images\\Bob-Ross.jpg";
            try {
        ...
        if (counter == 7) { //Question 8
            ...
            String imagePath = "D:\\artHub2\\musee\\src\\main\\resources\\images\\portrait-of-dr-gachet-van-gogh-reproduction.jpg";
            try {
                Image img = new Image(new FileInputStream(imagePath));
                image.setImage(img);
            }catch (FileNotFoundException e)
        ...
        if (counter == 8) { //Question 9
            ...
            String imagePath = "D:\\artHub2\\musee\\src\\main\\resources\\images\\van-gogh-museum.jpg";
            try {
                Image img = new Image(new FileInputStream(imagePath));
                image.setImage(img);
            }catch (FileNotFoundException e)
        ...
        if (counter == 9) { //Question 10
            ...
            String imagePath = "D:\\artHub2\\musee\\src\\main\\resources\\images\\mona-lisa.jpg";
            try {
                Image img = new Image(new FileInputStream(imagePath));
                image.setImage(img);
            }catch (FileNotFoundException e)
