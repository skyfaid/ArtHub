...
public class PaymentProcessor {
    private static final String STRIPE_API_KEY = "sk_test_51OpEzAFLYxbIwHifovQPJ4A9Lkc5qRajtYH9xXQnfUAYeUgQWCjgRzZocLHVbxyVmakYxPpGzCphIv45dTEVTDJg00q7ecfti2"; // your API secret key

    public static boolean processPayment(String name, String email, double amount, String cardNumber, int cardExpMonth, int cardExpYear, String cardCvc) throws StripeException {
