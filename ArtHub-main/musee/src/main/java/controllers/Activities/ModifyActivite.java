...
public class ModifyActivite {
    ...
    */
    ...
    void modifier(ActionEvent event) {
        try {
            String currentNomActivite = modifyFX.getText(); // Get the current name from the TextField.
            String newNomActivite = nomTF.getText(); // This is the new name for the activity.
            int nbrePlaces = Integer.parseInt(nbreTF.getText());
            // Validation for dates can be added here if needed.
            // Create an Activite object with the new details.
            Activite activite = new Activite();
            activite.setNom_act(newNomActivite); // Set the new name.
            // ... set other properties like dateDebut, dateFin, etc.
            ...
            //imageURL = selectedACT.getPosterUrl();
            // Update the event in the service
            activite.setPosterUrl(imageURL);
            //serviceActivite.modifier(activite);

            // Call the service method to update the Activite.
