...
import controllers.Oeuvres.OeuvresClient;
...
public class UserInterfaceController implements UserUpdateListener {
    ...
    private entities.Serverclass serveur;
    @FXML
    ...
    protected void onOeuvresButtonClick(ActionEvent event) {
        ...
        try {
            ...
            //VBox listEventsPane = FXMLLoader.load(getClass().getResource("/guiOeuvre/OeuvresClient.fxml"));
            //contentPane.getChildren().setAll(listEventsPane);
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/guiOeuvre/OeuvresClient.fxml"));
            AnchorPane pane_event = loader.load();
            OeuvresClient controller = loader.getController();
            controller.setCurrUser(utilisateurConnecte);
            contentPane.getChildren().setAll(pane_event);
    ...
    public void onchatButtonClick(ActionEvent event) {
        ...
        try {
            ...
            contentPane.getChildren().setAll(pane_event);
            serveur = Serverclass.getInstance();
