...
public class Serverclass {
     ...
     */
    private Serverclass() throws IOException {
    ...
    public static Serverclass getInstance() throws IOException {
        return Serverclass!=null? Serverclass:(Serverclass=new Serverclass());
    }
